  ...
  return (
    <div className="min-h-screen w-full pt-32 pb-24 bg-background">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-serif text-foreground mb-6">{t.experiences.heading}</h1>
        ...
        <Tabs defaultValue="all" value={activeCategory} onValueChange={setActiveCategory} className="w-full">
          <TabsList className="flex flex-wrap justify-center bg-transparent border-b border-border w-full h-auto p-0 mb-12">
            {categories.map((cat) => (
              ...
              >
                {t.experiences.categories[cat.id]}
              </TabsTrigger>
            ))}
          </TabsList>
          ...
          <div className="mt-8">
            {isLoading ? (
              ...
              <div className="text-center py-24 text-muted-foreground">
                <p>{t.experiences.noExperiences}</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <div className="flex items-center justify-between mt-auto mb-6 pt-4 border-t border-border">
                        ...
                        <div className="flex items-center gap-2 text-sm text-foreground/80">
                          ...
                          <span>${exp.price} {t.experiences.perPerson}</span>
                        </div>
                      </div>
